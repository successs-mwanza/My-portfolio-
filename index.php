    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="51">
        ...
        <div class="navbar navbar-expand-lg bg-light navbar-light">
            <div class="container-fluid">
                <a href="index.html" class="navbar-brand">PortiFolio</a>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-content">
                            ...
                            <h4><p>HELLO!!</p></h4>
                                <p>I'm</p>
                                <h1>Success Mwanza</h1>
                                <h2></h2>
                                <div class="typed-text">A Web Designer, A Web Developer, A Front End Developer, Apps Designer, Apps Developer</div>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-6 d-none d-md-block">
                        <div class="hero-image">
                            <img src="img/profile.jpg" alt="Hero Image">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <div class="about-text">
                                <p>
                             Am proficient in new emerging technologie with robust experience for designing system that meet  bussiness needs in a world of technologies.
                             I have worked on so many projects both mobile app and web systems
                                </p>
                            </div>
                            <div class="skills">
                ...
                <div class="row">
                    <div class="col-12">
                        <ul id="portfolio-filter">
                            ...
                            <li data-filter=".filter-1">Web Design and Development</li>
                            <li data-filter=".filter-2">Mobile Apps Development</li>
                            <li data-filter=".filter-3"> Machine Learning Egineer</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="container">
                    <div class="footer-info">
                        <h2>Success Mwanza</h2>
                        <h3>123 Street, Lusaka, Zambia</h3>
                        <div class="footer-menu">
                            <p>+260970780532</p>
                            <p>SuccessMwanza32@gmail.com</p>
                        </div>
                ...
                <div class="container copyright">
                    <p>&copy; <a href="#">MadTech</a>, All Right Reserved 
